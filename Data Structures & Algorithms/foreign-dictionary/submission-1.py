class Solution:
    def foreignDictionary(self, words: List[str]) -> str:
        ...
        def dfs(letter):
            #Cycle if we have seen the letter again, processed if we have not
            if letter in visited:
                return visited[letter]

            visited[letter] = True

            #Explore all neighbors and append to our postorder result
        ...
        #Cycle detection = no valid ordering
